...
public class PointRuleEngineImpl implements PointRuleEngine {
	...
	private List<String> getTestDrlFile() {
		...
		drlFilePath.add(this.getClass().getClassLoader().getResource("addpoint.drl").getPath());
		drlFilePath.add(this.getClass().getClassLoader().getResource("subpoint.drl").getPath());
